// SQLite connection + schema for 05-pdfgen-database. Document/default data
// is stored as document-level JSON blobs per form instance (data_json), not
// fully normalized down to individual rows — see the plan in
// glittery-growing-raven.md for why (no row-level queries are needed yet).
